...
There are many ways to fit the boxes in the greater box.
Say one iterates over box sizes, 
from the smallest to the largest, or from the largest to the smallest box.
...
Some of the scripts are available at:
